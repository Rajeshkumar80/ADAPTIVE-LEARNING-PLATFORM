...
const ACTION_ITEMS = [
  { id: "export-nodepad", icon: FolderDown,  label: "Export",  sub: ".codejournal"  },
  { id: "import-nodepad", icon: FolderInput, label: "Import",  sub: ".codejournal"  },
  { id: "export-md",      icon: Download,    label: "Export",  sub: "markdown"  },
  { id: "export-knowledge", icon: Download,  label: "Export",  sub: "knowledge doc"  },
  { id: "copy-md",        icon: Clipboard,   label: "Copy",    sub: "markdown"  },
  { id: "synthesize",     icon: Sparkles,    label: "Synthesize", sub: "knowledge" },
...
export function VimInput({ onSubmit, onCommand, isCommandKOpen, setIsCommandKOpen }: VimInputProps) {
  ...
  const sections = React.useMemo(() => [
    ...
    { start: viewCount + navCount, count: actionCount, cols: 4 },
